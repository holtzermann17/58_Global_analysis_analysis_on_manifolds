...
\usepackage{pmmeta}
\pmcanonicalname{Centralizer1}
\pmcreated{2013-03-22 14:01:20}
\pmmodified{2013-03-22 14:01:20}
\pmowner{yark}{2760}
...
\pmclassification{msc}{58E40}
\pmrelated{CentralizersInAlgebra}
...
The stabilizer of $X$ is called the \emph{centralizer} of $X$ and it's the set
\[C_G(X)=\{g\in G :  gxg^{-1}=x\quad\mbox{for all }x\in X\}\]
